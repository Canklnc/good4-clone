# GOOD4 ÜYELİK VE KULLANIM SÖZLEŞMESİ

**Sözleşme sürümü:** 1.0  
**Son güncelleme:** 24 Eylül 2026  
**Yürürlük:** Kullanıcının elektronik ortamda kabul ettiği tarih
...
Good4, her içeriğin yayımlanmadan önce inceleneceğini taahhüt etmez. Uygunsuz içerik, hesap güvenliği veya bu Sözleşmenin ihlali hakkındaki bildirimler **cannklnc7@gmail.com** adresine gönderilebilir. Başvuruda ilgili içerik veya hesabın tanımlanmasına yetecek bilgi ve bildirimin nedeni belirtilmelidir.
...
## 11. Hesabın kısıtlanması ve sona ermesi
...
Kullanıcı, uygulamada **Hesap Ayarları > Hesabımı sil** yolunu kullanarak hesap silme işlemini başlatabilir. Uygulamaya erişemeyen Kullanıcı, hesap silme talebini **cannklnc7@gmail.com** adresine iletebilir. Talebin işleme alınabilmesi için hesabın belirlenmesine yetecek bilgi istenebilir; Kullanıcı e-posta veya başvuru yoluyla parolasını ya da doğrulama kodunu göndermemelidir.
...
## 14. Sözleşmenin kabulü ve güncellenmesi
...
## 15. İletişim ve uyuşmazlıklar

Sözleşme, hesap, içerik veya hizmetle ilgili başvurular aşağıdaki kanallardan iletilebilir:
